	.text
	.file	"infinite.bc"
	.hidden	_ZN8infinite13store_accountEyRKNS_7accountE
	.globl	_ZN8infinite13store_accountEyRKNS_7accountE
	.type	_ZN8infinite13store_accountEyRKNS_7accountE,@function
_ZN8infinite13store_accountEyRKNS_7accountE:
	.param  	i64, i32
	block   	
	i64.load	$push0=, 8($1)
	i64.const	$push1=, 0
...
.LBB0_2:
	...
	.endfunc
.Lfunc_end0:
	.size	_ZN8infinite13store_accountEyRKNS_7accountE, .Lfunc_end0-_ZN8infinite13store_accountEyRKNS_7accountE

	.hidden	_ZN8infinite23apply_currency_transferERKNS_8transferE
	.globl	_ZN8infinite23apply_currency_transferERKNS_8transferE
	.type	_ZN8infinite23apply_currency_transferERKNS_8transferE,@function
_ZN8infinite23apply_currency_transferERKNS_8transferE:
	.param  	i32
...
.LBB1_1:
	...
	block   	
	i64.const	$push69=, 6
	i64.gt_u	$push2=, $6, $pop69
	br_if   	0, $pop2
	i32.load8_s	$push74=, 0($4)
	tee_local	$push73=, $3=, $pop74
	i32.const	$push72=, -97
	i32.add 	$push4=, $pop73, $pop72
	i32.const	$push71=, 255
	i32.and 	$push5=, $pop4, $pop71
	i32.const	$push70=, 25
	i32.gt_u	$push6=, $pop5, $pop70
	br_if   	1, $pop6
...
.LBB1_4:
	...
	i64.const	$8=, 0
	i64.const	$push76=, 11
	i64.le_u	$push3=, $6, $pop76
	br_if   	2, $pop3
	br      	3
.LBB1_5:
	end_block
	i32.const	$push81=, 208
	i32.add 	$push7=, $3, $pop81
	i32.const	$push80=, 0
	i32.const	$push79=, -49
	i32.add 	$push8=, $3, $pop79
	i32.const	$push78=, 255
	i32.and 	$push9=, $pop8, $pop78
	i32.const	$push77=, 5
	i32.lt_u	$push10=, $pop9, $pop77
	i32.select	$3=, $pop7, $pop80, $pop10
.LBB1_6:
	end_block
	i64.extend_u/i32	$push11=, $3
	i64.const	$push83=, 56
	i64.shl 	$push12=, $pop11, $pop83
	i64.const	$push82=, 56
	i64.shr_s	$8=, $pop12, $pop82
.LBB1_7:
	end_block
	i64.const	$push85=, 31
	i64.and 	$push14=, $8, $pop85
	i64.const	$push84=, 4294967295
	i64.and 	$push13=, $5, $pop84
...
.LBB1_8:
	...
	i64.or  	$7=, $8, $7
	i64.const	$push89=, -5
	i64.add 	$push88=, $5, $pop89
	tee_local	$push87=, $5=, $pop88
	i64.const	$push86=, -6
	i64.ne  	$push15=, $pop87, $pop86
	br_if   	0, $pop15
	end_loop
	i64.const	$6=, 0
	i64.const	$push92=, 0
	i64.store	24($9), $pop92
	i64.store	16($9), $7
	...
	i32.const	$push16=, 16
	i32.call	$drop=, load_i64@FUNCTION, $1, $pop18, $pop17, $pop62, $pop16
	i32.const	$push19=, 8
...
.LBB1_10:
	...
	block   	
	i64.const	$push93=, 6
	i64.gt_u	$push21=, $6, $pop93
	br_if   	0, $pop21
	i32.load8_s	$push98=, 0($4)
	tee_local	$push97=, $3=, $pop98
	i32.const	$push96=, -97
	i32.add 	$push23=, $pop97, $pop96
	i32.const	$push95=, 255
	i32.and 	$push24=, $pop23, $pop95
	i32.const	$push94=, 25
	i32.gt_u	$push25=, $pop24, $pop94
	br_if   	1, $pop25
...
.LBB1_13:
	...
	i64.le_u	$push22=, $6, $pop100
	br_if   	2, $pop22
	br      	3
.LBB1_14:
	end_block
	i32.const	$push105=, 208
	i32.add 	$push26=, $3, $pop105
	i32.const	$push104=, 0
	i32.const	$push103=, -49
	i32.add 	$push27=, $3, $pop103
	i32.const	$push102=, 255
	i32.and 	$push28=, $pop27, $pop102
	i32.const	$push101=, 5
	i32.lt_u	$push29=, $pop28, $pop101
	i32.select	$3=, $pop26, $pop104, $pop29
.LBB1_15:
	end_block
	i64.extend_u/i32	$push30=, $3
	i64.const	$push107=, 56
	i64.shl 	$push31=, $pop30, $pop107
	i64.const	$push106=, 56
	i64.shr_s	$8=, $pop31, $pop106
.LBB1_16:
	end_block
	i64.const	$push109=, 31
	i64.and 	$push33=, $8, $pop109
	i64.const	$push108=, 4294967295
	i64.and 	$push32=, $5, $pop108
	i64.shl 	$8=, $pop33, $pop32
.LBB1_17:
	end_block
	i32.const	$push115=, 1
	i32.add 	$4=, $4, $pop115
	...
	i64.or  	$7=, $8, $7
	i64.const	$push113=, -5
	i64.add 	$push112=, $5, $pop113
	tee_local	$push111=, $5=, $pop112
	i64.const	$push110=, -6
	i64.ne  	$push34=, $pop111, $pop110
	br_if   	0, $pop34
	end_loop
	i64.const	$push123=, 0
	i64.store	8($9), $pop123
	i64.store	0($9), $7
	i64.const	$push35=, 5093418677655568384
	i64.const	$push122=, 3607749778735104000
	i32.const	$push121=, 16
	i32.call	$drop=, load_i64@FUNCTION, $1, $pop35, $pop122, $9, $pop121
	block   	
	i32.const	$push63=, 16
	i32.add 	$push64=, $9, $pop63
	i32.const	$push120=, 8
	i32.add 	$push119=, $pop64, $pop120
	tee_local	$push118=, $4=, $pop119
	i64.load	$push117=, 0($pop118)
	tee_local	$push116=, $6=, $pop117
	i64.eqz 	$push36=, $pop116
	br_if   	0, $pop36
	i64.load	$8=, 16($0)
...
.LBB1_20:
	...
	call    	assert@FUNCTION, $pop37, $pop136
	i64.load	$push38=, 0($4)
	i64.load	$push135=, 0($2)
	tee_local	$push134=, $6=, $pop135
	i64.sub 	$push39=, $pop38, $pop134
	i64.store	0($4), $pop39
	i32.const	$push133=, 8
	i32.add 	$push132=, $9, $pop133
	tee_local	$push131=, $3=, $pop132
	i64.load	$push40=, 0($pop131)
	i64.add 	$push41=, $6, $pop40
	i64.ge_u	$push42=, $pop41, $6
	i32.const	$push130=, .L.str.4
	call    	assert@FUNCTION, $pop42, $pop130
	i64.load	$push43=, 0($3)
	i64.load	$push129=, 0($2)
	tee_local	$push128=, $8=, $pop129
	i64.add 	$push44=, $pop43, $pop128
	i64.store	0($3), $pop44
	i64.load	$push127=, 0($4)
	tee_local	$push126=, $6=, $pop127
	i64.const	$push125=, 0
	i64.ne  	$push45=, $pop126, $pop125
	br_if   	0, $pop45
.LBB1_21:
	end_loop
	end_block
	i64.load	$push46=, 0($0)
	i64.const	$push140=, 3607749778735104000
	i32.const	$push65=, 16
	i32.add 	$push66=, $9, $pop65
	i32.call	$drop=, remove_i64@FUNCTION, $pop46, $pop140, $pop66
	i32.const	$push139=, 8
	i32.add 	$push50=, $0, $pop139
	i64.load	$6=, 0($pop50)
	block   	
	block   	
	i32.const	$push138=, 8
	i32.add 	$push47=, $9, $pop138
	i64.load	$push48=, 0($pop47)
	i64.const	$push137=, 0
	i64.eq  	$push49=, $pop48, $pop137
	br_if   	0, $pop49
	i64.const	$push52=, 3607749778735104000
	i32.const	$push51=, 16
	i32.call	$drop=, store_i64@FUNCTION, $6, $pop52, $9, $pop51
	br      	1
.LBB1_23:
	end_block
	i64.const	$push53=, 3607749778735104000
	i32.call	$drop=, remove_i64@FUNCTION, $6, $pop53, $9
.LBB1_24:
	end_block
	i32.const	$push60=, 0
	i32.const	$push58=, 32
	...
	.endfunc
.Lfunc_end1:
	.size	_ZN8infinite23apply_currency_transferERKNS_8transferE, .Lfunc_end1-_ZN8infinite23apply_currency_transferERKNS_8transferE
...
.LBB3_18:
	...
	call    	_ZN8infinite23apply_currency_transferERKNS_8transferE@FUNCTION, $pop46
.LBB3_21:
	end_block
	i32.const	$push42=, 0
	i32.const	$push40=, 32
