 ...
 */
#ifndef TOKEN_NAME
#define TOKEN_NAME myacc2
#define N_TOKEN_NAME N(myacc)
#endif
...
namespace TOKEN_NAME {
   ...
   */
   typedef eosio::token<uint64_t,N_TOKEN_NAME> currency_tokens;
   ...
   **/
   using accounts = eosio::table<N(defaultscope),N_TOKEN_NAME,N(account),account,uint64_t>;
